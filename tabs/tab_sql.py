...
import csv
import config
from database import connect_to_database, populate_databases_choice

class SqlTab(wx.Panel):
    def __init__(self, parent, main_frame=None, fut_place=None):
        ...
        # --- Вибір бази даних ---
        db_choice_sizer = wx.BoxSizer(wx.HORIZONTAL)
        db_choice_sizer.Add(wx.StaticText(self, label="Цільова база даних:"), 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 10)
        
        self.db_choice = wx.Choice(self)
        db_choice_sizer.Add(self.db_choice, 1, wx.EXPAND)
        main_sizer.Add(db_choice_sizer, 0, wx.EXPAND | wx.ALL, 5)

        # Заповнюємо список доступними базами
    ...
    def load_databases_to_choice(self):
        populate_databases_choice(self.db_choice) 
